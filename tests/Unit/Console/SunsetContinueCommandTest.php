...
class SunsetContinueCommandTest extends TestCase
{
    public function test_command_has_correct_signature(): void
    {
        $command = new SunsetContinueCommand();

        $this->assertSame('sunset:continue', $command->getName());
    }
    ...
    public function test_command_can_be_instantiated(): void
    {
        ...
        $this->assertInstanceOf(SunsetContinueCommand::class, $command);
    }
    ...
    public function test_handle_calls_all_on_master_repository_and_exits_zero_when_empty(): void
    {
        ...
        Artisan::starting(function ($artisan) {
            $artisan->resolveCommands([SunsetContinueCommand::class]);
        });

        $this->artisan('sunset:continue')->assertExitCode(0);
    }
