...
#[AsCommand(name: 'sunset:supervise')]
class SunsetSuperviseCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sunset:supervise
     ...
     *
     * @param  \Admnio\Sunset\Supervisor\SupervisorFactory  $factory
     * @return int|null
     */
     ...
     *
     * @return \Admnio\Sunset\Supervisor\SupervisorOptions
     */
